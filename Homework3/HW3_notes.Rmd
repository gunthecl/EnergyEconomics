...
We implement the constraints in accordance with the approach by Ehrenmann and Smeers (p.11). 
The flow on a line can be calculated via the sum of PTDF coefficient times the net injection.
(Why two contraints? )
